...
// Transposes a matrix that is [2] rows by [5] columns to a matrix that has [5] rows by [2] columns  
 M_5x2 Transpose(M_2x5  value) {return {value.M1.N1,value.M2.N1,value.M1.N2,value.M2.N2,value.M1.N3,value.M2.N3,value.M1.N4,value.M2.N4,value.M1.N5,value.M2.N5};};
// Transposes a matrix that is [3] rows by [5] columns to a matrix that has [5] rows by [3] columns  
 M_5x3 Transpose(M_3x5  value) {return {value.M1.N1,value.M2.N1,value.M3.N1,value.M1.N2,value.M2.N2,value.M3.N2,value.M1.N3,value.M2.N3,value.M3.N3,value.M1.N4,value.M2.N4,value.M3.N4,value.M1.N5,value.M2.N5,value.M3.N5};};
// Transposes a matrix that is [4] rows by [5] columns to a matrix that has [5] rows by [4] columns  
 M_5x4 Transpose(M_4x5  value) {return {value.M1.N1,value.M2.N1,value.M3.N1,value.M4.N1,value.M1.N2,value.M2.N2,value.M3.N2,value.M4.N2,value.M1.N3,value.M2.N3,value.M3.N3,value.M4.N3,value.M1.N4,value.M2.N4,value.M3.N4,value.M4.N4,value.M1.N5,value.M2.N5,value.M3.N5,value.M4.N5};};